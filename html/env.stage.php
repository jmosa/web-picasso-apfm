...
define('DB_USER', getenv('PICASSO_DB_USER') ?: 'pablo');

/** MySQL database password */
define('DB_PASSWORD', getenv('PICASSO_DB_PASSWORD') ?: '6z1VJ9EsVtm5SHWVSUV1SvKO9hY9k0b');

/** MySQL hostname */
define('DB_HOST', getenv('PICASSO_DB_HOST') ?: 'web-aurora-stage.cluster-cs5n7n8fqpho.us-west-2.rds.amazonaws.com');
...
define(
	...
	serialize(
		array(
			...
			'bucket' => getenv('PICASSO_AS3CF_BUCKET') ?: 'img.stage.aplaceformom.com',
			...
			'cloudfront' => getenv('PICASSO_AS3CF_CDN_DOMAIN') ?: 'img.stage.aplaceformom.com',
